...
function Clothing() {
  return (
    <div className="About">
      <header className="bg-[#052747] text-[aliceblue] flex h-[80px] items-center justify-between mb-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        <Card className="flex w-[300px] h-[400px] items-center justify-center ml-[258px]">
          <CardContent>
            <img
        ...
        <Card className="w-[250px] h-[400px] mx-4">
          <CardContent>
            <img
              src="images/cloth.jpg"
              className="flex items-center justify-center h-[200px] w-[250px] mb-3 mt-6 rounded"
            />
            <h2 className="text-[#052747] ">The Silky Tassels</h2>
          </CardContent>
        </Card>
        <Card className="w-[250px] h-[400px] mx-4">
          <CardContent>
